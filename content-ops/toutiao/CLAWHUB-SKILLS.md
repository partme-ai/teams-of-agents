...
技能总表有具体 Slug 后，每个技能：**安装** `clawhub install <slug>`，**卸载** `clawhub uninstall <slug>`。示例：`clawhub install toutiao-xxx` / `clawhub uninstall toutiao-xxx`。
