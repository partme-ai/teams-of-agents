...
|------|-------|----------|----------|------|
| 1 | juejin-hot-monitor | 链接抓取、日报格式 | baoyu-url-to-markdown, baoyu-format-markdown | skills.sh |
...
|------|----------|----------|----------|------|------|
| 1 | 发布到掘金 | 多平台发布含掘金 | social-push | skills.sh / ClawHub | publisher 按需 |
...
| 序号 | 补充能力 | 技能 | 来源 |
|------|----------|------|------|
| 1 | 发布到掘金 | social-push | skills.sh / ClawHub |
| 2 | 多语言 | baoyu-translate | skills.sh |
| 3 | 信息图/漫画风 | baoyu-infographic、baoyu-comic | skills.sh |

### 6.3 全部不冲突：全部安装命令与全部卸载命令

**能用上的全要**：以 skills.sh Baoyu 全列为主；ClawHub 若有掘金相关 slug 可追加。

**全部安装命令**

```bash
# ClawHub — clawhub search juejin 后按需 install
