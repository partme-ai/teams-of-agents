...
> 来源：[skills.sh/?q=baoyu](https://skills.sh/?q=baoyu)、[skills.sh/?q=juejin](https://skills.sh/?q=juejin)。安装方式：`npx skills add <owner/repo> --skill <技能名>`。与 [CLAWHUB-SKILLS.md](./CLAWHUB-SKILLS.md) 并列。技术内容向，可选用 social-push 等多平台发布。
...
|------|------------|------------------------------------------|
| 1 | juejin-hot-monitor | baoyu-url-to-markdown, baoyu-format-markdown |
| 2 | juejin-viral-breakdown | baoyu-url-to-markdown, baoyu-format-markdown |
| 3 | juejin-rewrite / juejin-write | baoyu-cover-image, baoyu-article-illustrator；可选 baoyu-infographic, baoyu-comic |
| 4 | juejin-publisher | baoyu-compress-image；可选 social-push |
| 5 | juejin-data-assistant | baoyu-format-markdown |
| 6 | juejin-comment-manager | 按需 ClawHub/skills.sh |
