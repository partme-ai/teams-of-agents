...
| 序号 | 能力 | 首选 | 备选/不重复装 |
|------|------|------|----------------|
| 1 | 链接→Markdown | baoyu-url-to-markdown | — |
| 2 | 报告/拆解格式 | baoyu-format-markdown | — |
| 3 | 封面/长文配图 | baoyu-cover-image, baoyu-article-illustrator | — |
| 4 | 发布到微博 | baoyu-post-to-weibo 或 social-push | 按需选一 |
...
7 个智能体**全部可使用的技能**（全部不冲突）的安装与卸载命令在**本报告第七节 7.3** 中完整列出。config 中 `agents.list[].skills` 填写的即为「安装后目录名」：ClawHub 即 `<slug>`，skills.sh 即技能名（如 `baoyu-url-to-markdown`）。微博管线当前 ClawHub 技能待补充，**能用上的全要**以 skills.sh Baoyu 全系 + 可选 baoyu-post-to-weibo 为主。
...
| 3 | 微博发布 | 将草稿发布到微博 | baoyu-post-to-weibo | skills.sh | 与 social-push 按需选一 |
...
| 3 | 微博发布 | baoyu-post-to-weibo | skills.sh |
...
*完整技能表见 [CLAWHUB-SKILLS.md](./CLAWHUB-SKILLS.md)、本目录 [README.md](./README.md)。*
