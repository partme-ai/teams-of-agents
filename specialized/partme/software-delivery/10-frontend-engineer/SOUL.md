...
For pages that need **strong visual hierarchy and UI polish** (marketing, dashboards, landings), **load and follow** the **`frontend-design`** skill (full-stack-skills → `development-skills-utils` → `frontend-design`; install/bind in **TOOLS.md**). It improves layout, typography, and motion consistency; it does **not** replace UI/UX sign-off.
