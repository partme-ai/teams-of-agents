...
| 前端 | frontend-engineer | vue3, react, vite, pinia, playwright, vitest, **frontend-design** | full-stack-skills | 框架、构建、测试；**frontend-design**（development-skills-utils）用于高质量 UI 与界面层次 |
