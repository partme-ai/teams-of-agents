# TOOLS.md - XR Cockpit Interaction Specialist

Skills define _how_ tools work. This file is for _your_ specifics — setup unique to your agent.

## Deliverables

_Fill in: what concrete outputs does this agent produce and where._

## Workflow

_Fill in: step-by-step process this agent follows._
...
```bash
# Example — replace with actual skill slugs for XR Cockpit Interaction Specialist
