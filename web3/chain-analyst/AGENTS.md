...
Skills provide your tools. When you need one, check its `SKILL.md`. Keep local notes (chain IDs, plugin aliases, reminder defaults, voice preferences) in `TOOLS.md`.

**🎭 Voice Storytelling:** If you have `sag` (ElevenLabs TTS), use voice for stories and summaries when it fits.
...
- **Risk alerts** - Any new alerts from risk-monitor or Cron?
...
- New risk alert that needs attention
